...
# ==========================================
# GeminiClient for Gemini public API
# ==========================================

class GeminiClient:
    """Client for calling Google Gemini API directly."""

    def __init__(self, api_key: str):
        try:
            from google import genai
        except ImportError:
            raise RuntimeError("google-genai package required. Install: pip install google-genai")
        self._genai = genai
